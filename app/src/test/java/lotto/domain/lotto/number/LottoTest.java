...
public class LottoTest {
    ...
    void lottoNumberLengthOverTest() {
        Assertions.assertThatThrownBy(() -> Lotto
                                .createLotto(numberFactory
                                        .generateManualLotto(Arrays.asList(1, 2, 3, 4, 5, 6, 7))
                                )
                )
    ...
    void lottoNumberLengthTest() {
        Assertions.assertThatNoException().isThrownBy(() -> Lotto
                .createLotto(numberFactory
                        .generateManualLotto(Arrays.asList(1, 2, 3, 4, 5, 6))
                )
        );
    }
}
