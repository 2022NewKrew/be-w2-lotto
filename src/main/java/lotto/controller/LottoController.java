...
public class LottoController {
    ...
    public void lottoRun(){
        ...
        lottoObject.setLottoResult(new LottoNumber(LottoViewInput.lottoInputToList(() -> {System.out.println("지난 주 당첨 번호를 입력해 주세요.");}), LOTTO_AUTO), LottoViewInput.lottoInputResultBonus()); //로또 결과 입력
