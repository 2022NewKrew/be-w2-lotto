...
public class AutoLottoGenerator implements LottoGenerator {
    ...
    private final List<LottoNumber> randomLottoNumberList = IntStream.rangeClosed(MIN_NUMBER,
            MAX_NUMBER)
    ...
    private @NotNull Lotto generateRandomLotto()
        throws DuplicationException, NumOfLottoNumbersMismatchException {
