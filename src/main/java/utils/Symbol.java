...
public class Symbol {
    ...
    public static final String MANNUAL_COUNT_MESSAGE = "수동으로 구매할 로또 수를 입력해 주세요.";
    public static final String MANNUAL_INPUT_MESSAGE = "수동으로 구매할 번호를 입력해 주세요.";
    ...
    public static final String INVALID_MANNUAL_LOTTOCOUNT = "수동으로 구매하는 로또 수는 전체 로또 수를 초과할 수 없습니다.";
