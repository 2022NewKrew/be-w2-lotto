...
public class LottoResultCheck {
     ...
     */
    private final List<int[]> userLottos;
    private final int[] winningLotto;
    private final int bonus;

    public LottoResultCheck(List<int[]> userLottos, int[] winningLotto, int bonus) {
     ...
     */
    private void visitAllState(Map<LottoResultState, Integer> result, int[] userLotto) {
        for (LottoResultState state : LottoResultState.values()) {
     ...
     */
    private void addResultHaskMap(Map<LottoResultState, Integer> result, int[] userLotto, LottoResultState state) {
