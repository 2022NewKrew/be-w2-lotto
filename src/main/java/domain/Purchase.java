...
public class Purchase {
    ...
    public Purchase(int amount, int autoGeneratedLottoQuantity, int manualGeneratedLottoQuantity) {
        ...
        assertValidPurchaseQuantity(amount, autoGeneratedLottoQuantity, manualGeneratedLottoQuantity);
        this.amount = amount;
    ...
    private void assertValidPurchaseQuantity(int amount, int autoGeneratedLottoQuantity, int manualGeneratedLottoQuantity) throws IllegalArgumentException {
