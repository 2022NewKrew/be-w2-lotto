...
public class OutputView {
    ...
    public static void announceBeforeManualLine() {System.out.println("수동으로 구매할 번호를 입력해 주세요.");}

    public static void announceBeforeWinningLine() {System.out.println("지난 주 당첨 번호를 입력해 주세요.");}
