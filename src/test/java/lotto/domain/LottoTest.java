...
class LottoTest {
    ...
    void invalidDuplicationCreate(String numbers, String expectedMessage) {
        ...
        DuplicationException iae = assertThrows(DuplicationException.class,
    ...
    void invalidNumOfLottoNumbersCreate(String numbers, String expectedMessage) {
        List<LottoNumber> lottoNumberList = getLottoNumberListFrom(numbers);
        NumOfLottoNumbersMismatchException iae = assertThrows(
            NumOfLottoNumbersMismatchException.class, () -> new Lotto(lottoNumberList));
        assertEquals(iae.getMessage(), expectedMessage);
    }
    ...
    void getNumOfMatchingNumbersWith(String numbers1, String numbers2) {
        ...
        Assertions.assertTrue(
            lotto1.getNumOfMatchingNumbersWith(lotto2) <= NUM_OF_LOTTO_NUMBERS_IN_LOTTO);
    }
}