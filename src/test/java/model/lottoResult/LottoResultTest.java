...
class LottoResultTest {
    ...
    void getResult(int money, Lotto winningLotto, LottoNumber bonusNumber, Map<Integer, Integer> expectedEarn) {
        //Give
    ...
    void getRevenuePercent(int money, Lotto winningLotto, LottoNumber bonusNumber, int expectedRevenuePercent) {
        //Give
        List<Lotto> lottos = SellLottoController.buyLottos(money);
        //When
        LottoResult lottoResult = new LottoResult(lottos, winningLotto, bonusNumber);
