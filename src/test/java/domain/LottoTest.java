...
class LottoTest {
    ...
    @Test
    void 로또_당첨_결과() {
        LottoResults lottoResults = lotto.checkLottoResults(List.of(new BasicNumber(7), new BasicNumber(11), new BasicNumber(20),
    ...
    void 로또_당첨_금액_확인() {
        LottoResults lottoResults = lotto.checkLottoResults(List.of(new BasicNumber(7), new BasicNumber(11), new BasicNumber(20),
                new BasicNumber(31), new BasicNumber(23), new BasicNumber(36), new BonusNumber(28)));
        assertEquals(10_000, lottoResults.getEarnedMoney());
    }
